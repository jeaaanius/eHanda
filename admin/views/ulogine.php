...
// Account details
	...
	$message = rawurlencode('Your OPT For eHanda Emergency Login is: 2551');
            ...
            <div class="body">
                <form id="" method="POST" action="ulogine.php">
                    <?php if ($error=='') { 
                         ...
                         ?> <div class="msg">Sign in to start using eHanda</div> <?php
                    }
                    else
                        {
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="adharno" placeholder="Enter Your Tel No" required autofocus>
                        </div>
                    </div>
